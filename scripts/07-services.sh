...
for svc in jack mod-host mod-ui browsepy mod-amidithru mod-ala-pi-stomp pistomp-recovery firstboot pistomp-lcd-splash pistomp-ro-recovery lcd-reboot lcd-shutdown; do
